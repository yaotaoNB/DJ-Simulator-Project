...
public class BeatMatch_Nikil : MonoBehaviour {
	...
	void checkForString(){
		...
		//print("i199 0 1 \"" + Application.dataPath + "/Audio/" + songToPlayLeft + "\"");
		//csoundunity.setStringChannel ("SongPlay", songToPlayLeft);
		/*csoundunity.sendScoreEvent("i199 0 0.001 \"" + Application.dataPath + "/Audio/" + songToPlayLeft + "\"");*/
		skipTimeS = "  " + skipTime;
		csoundunity.sendScoreEvent("i199 0 0.001 \"" + Application.dataPath + "/Audio/" + songToPlayLeft + "\"" + skipTimeS);
	...
	void setUp(){
		...
		csoundunity.setChannel ("SkipTime",60f);
//		songToPlayLeft = "Everyday.ogg";
//		csoundunity.setStringChannel ("SongPlay", songToPlayLeft);
		//csoundunity.setStringChannel ("SongPlay", songToPlayLeft);
	...
	void cuePoints(){
		if (skipTime != skiptimePre) {
			skipTimeS = "  " + skipTime;
			csoundunity.sendScoreEvent("i199 0 0.001 \"" + Application.dataPath + "/Audio/" + songToPlayLeft + "\"" + skipTimeS);
			skiptimePre = skipTime;
		}
	}
