...
Sfile_new		strcpy	""		
	...
	NEW_FILE:
	SAudioFile sprintf "%s",Ssong
	
	;ifilel		ftgentmp	0, 0, 0, 1, SAudioFile,i(kcue),0,1
	;ifiler		ftgentmp	0, 0, 0, 1, SAudioFile,i(kcue),0,2		
 ifile		ftgentmp	0, 0, 0, 1, SAudioFile,i(kcue),0,1										

;asigl		temposcal	 ktime,kamp,kpitch, ifilel, 1, 2048
